...
ALTER TABLE `scene`
ADD FOREIGN KEY (`story_id`) REFERENCES `story` (`id`) ON DELETE CASCADE;

ALTER TABLE `choice`
ADD FOREIGN KEY (`scene_id`) REFERENCES `scene` (`id`) ON DELETE CASCADE;

ALTER TABLE `dialogue_line`
ADD FOREIGN KEY (`scene_id`) REFERENCES `scene` (`id`) ON DELETE CASCADE;

ALTER TABLE `dialogue_line`
ADD FOREIGN KEY (`character_id`) REFERENCES `character` (`id`) ON DELETE CASCADE;

ALTER TABLE `history`
ADD FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE;

ALTER TABLE `history`
ADD FOREIGN KEY (`choice_id`) REFERENCES `choice` (`id`) ON DELETE CASCADE;
